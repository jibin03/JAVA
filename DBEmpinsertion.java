...
con =
DriverManager.getConnection("jdbc:mysql://localhost:3306/emp_db?characterEncoding=utf8","root","");
...
str3 = "select e.eno , e.ename, e.esal , d.dname , d.dloc from emp e inner
...
+ " " + rs.getString("esal") + " " + rs.getString("dname") + " " + rs.getString("dloc"));
}
}
catch(Exception e) {
